...
cd /d "%~dp0"
title Model BUK v0.9.1 Server - PORT 8010 - NIE ZAMYKAJ

echo ================================================
echo          MODEL BUK v0.9.1 - START APLIKACJI
echo ================================================
echo.
...
start "" /b .venv\Scripts\python.exe -c "import time,webbrowser; time.sleep(4); webbrowser.open('http://127.0.0.1:8010/?v=091')"
